                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Responden</th>
                    ...
                    <div class="px-6 py-4 space-y-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="c_email" class="block text-sm font-medium text-gray-700">Email <span class="text-red-500">*</span></label>
                    ...
                    <div class="px-6 py-4 space-y-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="e_email" class="block text-sm font-medium text-gray-700">Email <span class="text-red-500">*</span></label>
